...
export const labels = {
  ...
  // ツールバーアクション
  add_block: "ブロック追加",
  open_template_modal: "テンプレート",
  sample_load: "サンプル読込",
  start_guide: "スタートガイド",
  start_guide_desc: "テンプレートを選ぶか、セルの「＋ここに追加」から開始できます",
  add_here: "ここに追加",
  replace_confirm: "現在の編集内容が上書きされます。よろしいですか？",
  merge_failed: "テンプレートのマージに失敗しました",
  apply_failed: "テンプレート適用に失敗しました",
  validate: "検証",
  undo: "元に戻す",
  redo: "やり直す",
  zoom_in: "拡大",
